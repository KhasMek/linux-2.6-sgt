...
rm ../KERNEL_BACKUPS/KhasMek.Voodoo.Plus.CDMA.Tab."$DATE".CM7.OC.zip
rm ../KERNEL_BACKUPS/KhasMek_"$DATE"_CM7_CM7_zImage
...
cp arch/arm/boot/zImage ../KERNEL_BACKUPS/KhasMek_"$DATE"_CM7_CM7_zImage
cp arch/arm/boot/zImage update/kernel_update/zImage
cd update
zip -r kernel_update.zip . 
java -classpath ../../../android-sdk-linux_x86/tools/sign/testsign.jar testsign kernel_update.zip ../../KERNEL_BACKUPS/KhasMek.Voodoo.Plus.CDMA.Tab."$DATE".CM7.OC.zip
